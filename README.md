...
* old/Makefile.jobtap - Build jobtap plugin (hello_jobtap)
* old/hello_jobtap.c - Jobtap plugin
* old/qrmi_acquire.py - Called from qrmi_shell.lua
* old/qrmi_shell.lua - Lua plugin, concluded Lua is not appropriate
* old/Dockerfile.flux-sched-net - Based on Flux image, could not install rustc due to emulation issues (amd64, not aarch64)
